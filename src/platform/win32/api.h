...
#define MAKEINTRESOURCEA(N) ((c08*)((u64)((u16)(N))))
#define MAKEINTRESOURCEW(N) ((c16*)((u64)((u16)(N))))
...
#define WIN32__PROCS \
    ...
    PROC(Kernel32, b08,                         CopyFileA,                  Win32_CopyFileA,                  c08 *ExistingFileName, c08 *NewFileName, b08 FailIfExists) \
    PROC(Kernel32, b08,                         CopyFileW,                  Win32_CopyFileW,                  c16 *ExistingFileName, c16 *NewFileName, b08 FailIfExists) \
    PROC(Kernel32, b08,                         CreateDirectoryA,           Win32_CreateDirectoryA,           c08 *PathName, win32_security_attributes *SecurityAttributes) \
    ...
    PROC(Kernel32, s32,                         WideCharToMultiByte,        Win32_WideCharToMultiByte,        u32 CodePage, u32 Flags, c16 *WideCharStr, s32 WideCharCount, c08 *MultiByteStr, s32 MultiByteCount, c08 *DefualtChar, b08 *UsedDefaultChar) \
    ...
    PROC(Kernel32, void,                        OutputDebugStringA,         Win32_OutputDebugStringA,         c08 *OutputString) \
    PROC(Kernel32, void,                        Sleep,                      Win32_Sleep,                      u32 Milliseconds) \
    ...
    PROC(Kernel32, win32_handle,                CreateFileA,                Win32_CreateFileA,                c08 *FileName, u32 DesiredAccess, u32 ShareMode, win32_security_attributes *SecurityAttributes, u32 CreationDisposition, u32 FlagsAndAttributes, win32_handle TemplateFile) \
    PROC(Kernel32, win32_handle,                CreateFileW,                Win32_CreateFileW,                c16 *FileName, u32 DesiredAccess, u32 ShareMode, win32_security_attributes *SecurityAttributes, u32 CreationDisposition, u32 FlagsAndAttributes, win32_handle TemplateFile) \
    PROC(Kernel32, win32_handle,                CreateSemaphoreExW,         Win32_CreateSemaphoreExW,         win32_security_attributes *SemaphoreAttributes, s32 InitialCount, s32 MaximumCount, c16 *Name, u32 Flags, u32 DesiredAccess) \
    ...
    PROC(Kernel32, win32_handle,                FindFirstFileA,             Win32_FindFirstFileA,             c08 *FileName, win32_find_data_a *FindFileData) \
    PROC(Kernel32, win32_handle,                FindFirstFileW,             Win32_FindFirstFileW,             c16 *FileName, win32_find_data_w *FindFileData) \
    PROC(Kernel32, win32_handle,                GetProcessHeap,             Win32_GetProcessHeap,             void) \
    PROC(Kernel32, win32_module,                GetModuleHandleA,           Win32_GetModuleHandleA,           c08 *ModuleName) \
    PROC(Kernel32, win32_module,                GetModuleHandleW,           Win32_GetModuleHandleW,           c16 *ModuleName) \
    PROC(Kernel32, win32_module,                LoadLibraryA,               Win32_LoadLibraryA,               c08 *LibraryFileName) \
    PROC(Kernel32, win32_module,                LoadLibraryW,               Win32_LoadLibraryW,               c16 *LibraryFileName) \
    PROC(Kernel32, win32_process,               GetProcAddress,             Win32_GetProcAddress,             win32_module Module, c08 *ProcName) \
    ...
    PROC(Opengl32, win32_process,               wglGetProcAddress,          WGL_GetProcAddress,               c08 *Process) \
    ...
    PROC(User32,   b08,                         SetPropA,                   Win32_SetPropA,                   win32_window Window, c08 *String, win32_handle Data) \
    PROC(User32,   b08,                         SetPropW,                   Win32_SetPropW,                   win32_window Window, c16 *String, win32_handle Data) \
    ...
    PROC(User32,   s32,                         ToUnicode,                  Win32_ToUnicode,                  u32 VirtualKey, u32 Scancode, u08 *KeyState, c16 *Buffer, s32 BufferSize, u32 Flags) \
    ...
    PROC(User32,   win32_cursor,                LoadCursorA,                Win32_LoadCursorA,                win32_instance Instance, c08 *CursorName) \
    PROC(User32,   win32_cursor,                LoadCursorW,                Win32_LoadCursorW,                win32_instance Instance, c16 *CursorName) \
    ...
    PROC(User32,   win32_handle,                GetPropA,                   Win32_GetPropA,                   win32_window Window, c08 *String) \
    PROC(User32,   win32_handle,                GetPropW,                   Win32_GetPropW,                   win32_window Window, c16 *String) \
    ...
    PROC(User32,   win32_window,                CreateWindowExA,            Win32_CreateWindowExA,            u32 ExtendedStyle, c08 *ClassName, c08 *WindowName, u32 Style, s32 X, s32 Y, s32 Width, s32 Height, win32_window Parent, win32_menu Menu, win32_instance Instance, vptr Param) \
    PROC(User32,   win32_window,                CreateWindowExW,            Win32_CreateWindowExW,            u32 ExtendedStyle, c16 *ClassName, c16 *WindowName, u32 Style, s32 X, s32 Y, s32 Width, s32 Height, win32_window Parent, win32_menu Menu, win32_instance Instance, vptr Param) \
