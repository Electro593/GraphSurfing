...
#define OPENGL__EXT_DEBUG__PROCS \
    ...
    PROC(,u32,  glGetDebugMessageLog,   GL_GetDebugMessageLog, u32 Count, s32 BufSize, u32 *Sources, u32 *Types, u32 *IDs, u32 *Severities, s32 *Lengths, c08 *MessageLog) \
...
#define OPENGL__EXT__PROCS \
    ...
    PROC(,s32,  glGetUniformLocation,          GL_GetUniformLocation, u32 Program, c08 *Name) \
    ...
    PROC(,void, glGetProgramInfoLog,           GL_GetProgramInfoLog, u32 Program, s32 MaxLength, s32 *Length, c08 *InfoLog) \
    PROC(,void, glGetProgramiv,                GL_GetProgramiv, u32 Program, u32 Name, s32 *Params) \
    PROC(,void, glGetShaderInfoLog,            GL_GetShaderInfoLog, u32 Shader, s32 MaxLength, s32 *Length, c08 *InfoLog) \
    ...
    PROC(,void, glShaderSource,                GL_ShaderSource, u32 Shader, s32 Count, c08 **String, s32 *Length) \
