                      ...
                      r64 Number)
{
    ...
    u32 NameLength = PointerCount(Name, c08) + 1;
                      ...
                      str String)
{
    ...
    json *JSON = (json*)((u08*)Memory->Base + *Used);
    u32 NameLength = PointerCount(Name, c08) + 1;
    u32 StringLength = PointerCount(String, c08) + 1;
    str NameBase = (str)((u08*)JSON + sizeof(json));
             ...
             handle_pool *OutputPool)
{
    ...
    while(TRUE)
    {
        ...
        if(Chr_IsBase10(*C) || *C == '-' || *C == '.')
        {
            ...
            r64 Number = Str_To_R64(ValueBuffer);
            if(Current->Type == JSON_Object)
            {
...
{ \
    if(Current->Name) \
    { \
        u32 NameLength = PointerCount(Current->Name, c08); \
        *Cursor++ = '\"'; \
                  ...
                  memory_handle *Output)
{
    ...
    while(Current)
    {
        ...
        switch(Current->Type)
        {
            ...
            case JSON_String:
            {
                u32 StringLength = PointerCount(Current->String, c08);
