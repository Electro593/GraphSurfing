...
// #define Mem_Set(vptr__Dest, s32__Data, u64__Size) memset(vptr__Dest, s32__Data, u64__Size)
...
#define UTIL__MEM__EXPORTS \
    ...
    FUNC(hmem vptr, Heap_AllocateAligned, heap *Heap, u32 Size, u32 Alignment, b08 ShouldZeroMemory) \
    FUNC(void,      Heap_Resize,          hmem vptr *Data, u32 Size) \
    FUNC(void,      Heap_Free,            hmem vptr Data) \
    FUNC(u32,       Heap_GetSize,         hmem vptr Data) \
    FUNC(void,      Stack_Init,           vptr Base, u64 Size) \
    FUNC(void,      Stack_Push,           void) \
    FUNC(void,      Stack_Pop,            void) \
    FUNC(smem vptr, Stack_Allocate,       u64 Size) \
...
#define UTIL__MEM__FUNCS \
    ...
    FUNC(heap_header*, Heap_GetHeader,      hmem vptr Data) \
    FUNC(hmem vptr,    Heap_GetData,        heap_header *Header) \
    ...
    FUNC(void,         Heap_Copy,           hmem vptr Dest, hmem vptr Src, b08 ShouldZeroDest) \
