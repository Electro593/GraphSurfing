        ...
        u64 Size)
{
    #if 1
    u08 Data08 = (u08)Data;
    i128 Data128 = I128_Set_32(Data08);
            ...
            u32 Size)
{
    ...
    else if(Header->Size < Size) // Allocate new block
    {
        ...
        vptr AllocatedData = Heap_Allocate(Heap, Size);
                  ...
                  heap_data_DEBUG *DebugData)
{
    ...
    mem FileHandle;
    Platform_OpenFile(&FileHandle, "DEBUGOutput.txt", FILE_MODE__WRITE);
